      ...
      <div className='container'>
        ...
        <ul>
          <li data-aos='fade-right' data-aos-delay='300'>
            <BsPersonWorkspace className='li-icon' />
            Trabajo hace 2 años como desarrollador web en Fork Chile.
          </li>
          <li data-aos='fade-right' data-aos-delay='300'>
          ...
          <li data-aos='fade-right' data-aos-delay='400'>
            ...
            Solidos Conocimientos en HTML, CSS, JavaScript y Node.js.
          </li>
          <li data-aos='fade-right' data-aos-delay='500'>
            <GoRocket className='li-icon' />
            Interesado en oportunidades laborales que me permitan continuar mi
